...
import { addTask, changeStatus } from '@/reducers/tasksSlice'
import { Label } from '@radix-ui/react-label'
import React, { useState } from 'react'
import { useDispatch, useSelector } from 'react-redux'

export const FormularioRedux = () => {
    ...
    const tasks = useSelector( store => store.tareas.tasksList )
    ...
    return (
        <>
            <h1 className="m-4 text-4xl font-bold">Formulario Redux</h1>
